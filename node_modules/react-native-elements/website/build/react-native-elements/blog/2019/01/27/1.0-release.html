...
<li><p>Some colors have een removed from the colors file and some changed. Here's the list of colors from 0.19.1.</p></li>
</ul>
...
<li><code>badgeStyle</code> prop replaces <code>containerStyle</code> prop (<a href="https://github.com/react-native-training/react-native-elements/pull/1545">#1545</a>)</li>
...
<li>Removed <code>loadingRight</code> prop. Loading indicator <strong>only displays to left now</strong>. May re-add in future.</li>
...
<ul>
<li><p><code>FormInput</code> been renamed to <code>&lt;Input /&gt;</code> Component (<a href="https://github.com/react-native-training/react-native-elements/pull/497">#497</a>)</p>
<ul>
...
<li><p><code>FormLabel</code> has been removed. This is now built into the Input component by use of <code>label</code> prop. Props <code>labelStyle</code> and <code>labelProps</code> can be used to customize it.</p></li>
<li><p><code>FormValidationMessage</code> has been removed. This is now built into the Input component by use of <code>errorMessage</code> prop. Props <code>errorStyle</code> and <code>errorProps</code> can be used to customize it.</p></li>
</ul>
...
<blockquote>
<p>Lastly, here is the RNE v1 release in numbers: 139 commits (with over 80 PR's), 205 files changes (+13,398 | −7,359) &amp; over 20 contributors.</p>
</blockquote>
<hr>
