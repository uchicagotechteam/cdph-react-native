  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>104/118</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<a name='L646'></a><a href='#L646'>646</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (prevProps.value !== newValue) {
...
&nbsp;
  fireChangeEvent(event) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.props[event]) {
...
&nbsp;
  handleMeasure(name, x) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (
      currentSize &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >      width === currentSize.width </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >      height === currentSize.height</span>
    ) {
  ...
  getValue(gestureState) {
    ...
    const thumbLeft =
      ...
      (this.props.orientation === 'vertical'
        ? <span class="branch-0 cbranch-no" title="branch not covered" >gestureState.dy</span>
        : gestureState.dx);
&nbsp;
    const ratio = thumbLeft / length;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.props.step) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.props.orientation === 'vertical') {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sun Jan 27 2019 07:32:59 GMT-0400 (AST)
</div>
</div>
