...
<span class="branch-1 cbranch-no" title="branch not covered" >    WrappedComponent.name </span>||
<span class="branch-2 cbranch-no" title="branch not covered" >    'Component'}</span>)`;
&nbsp;
  return WithBadge;
};
&nbsp;
