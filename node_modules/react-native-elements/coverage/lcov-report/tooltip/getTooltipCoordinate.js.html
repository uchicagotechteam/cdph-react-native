...
<a name='L140'></a><a href='#L140'>140</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">24x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const getArea = (a, b) =&gt; a * b;
&nbsp;
...
export const getElementVisibleWidth = (elementWidth, xOffset, ScreenWidth) =&gt; {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (xOffset &gt;= 0) {
    return xOffset + elementWidth &lt;= ScreenWidth // is element fully visible?
      ? elementWidth // element is fully visible;
      : <span class="branch-1 cbranch-no" title="branch not covered" >ScreenWidth - xOffset;</span> // calculate visible width of scrolled element
  }
...
<span class="branch-2 cbranch-no" title="branch not covered" >    case 1:</span>
    case 2: {
      const leftOverSpace = ScreenWidth - newX;
      return leftOverSpace &gt;= tooltipWidth
        ? newX
        : <span class="branch-1 cbranch-no" title="branch not covered" >newX - (tooltipWidth - leftOverSpace + 10);</span>
    }
