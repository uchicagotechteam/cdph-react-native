...
&nbsp;
  toggleTooltip = () =&gt; {
    ...
    this.setState(prevState =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (prevState.isVisible &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!isIOS)</span> {
...
&nbsp;
  wrapWithPress = (toggleOnPress, children) =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (toggleOnPress) {
      return (
...
&nbsp;
    return (
      &lt;View
        style={{
          position: 'absolute',
          top: pastMiddleLine ? <span class="branch-0 cbranch-no" title="branch not covered" >yOffset - 13 </span>: yOffset + elementHeight - 2,
          left:
            xOffset +
...
const styles = {
  container: withOverlay =&gt; ({
    backgroundColor: withOverlay ? 'rgba(250, 250, 250, 0.70)' : <span class="branch-1 cbranch-no" title="branch not covered" >'transparent',</span>
    flex: 1,
  }),
};
&nbsp;
